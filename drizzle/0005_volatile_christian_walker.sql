...
ALTER TABLE `users` ADD `profession` varchar(120);--> statement-breakpoint
ALTER TABLE `users` ADD `grossMonthlyIncome` int;--> statement-breakpoint
ALTER TABLE `users` ADD `maritalStatus` varchar(40);--> statement-breakpoint
ALTER TABLE `users` ADD `householdIncome` int;--> statement-breakpoint
ALTER TABLE `users` ADD `rg` varchar(32);--> statement-breakpoint
ALTER TABLE `users` ADD `nationality` varchar(80);--> statement-breakpoint
