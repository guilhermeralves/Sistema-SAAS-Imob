...
export function renderWelcomeClientTemplate(input: WelcomeClientTemplateInput) {
  return renderEmailLayout({
    title: "Bem-vindo(a) a AFG Imobiliaria",
    preheader: "Seu acesso ao portal da AFG foi criado com sucesso.",
    greeting: `Ola, ${input.name}!`,
    intro: "Seu cadastro no portal da AFG Imobiliaria foi concluido com sucesso. A partir de agora voce ja pode acessar sua conta e acompanhar as proximas etapas com mais facilidade.",
    highlights: [
    ...
    ctaUrl: input.appUrl,
    footerText: "Se voce nao reconhece este cadastro, responda a este e-mail ou entre em contato com a equipe da AFG Imobiliaria.",
  });
}
