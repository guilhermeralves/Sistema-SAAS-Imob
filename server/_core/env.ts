...
export const ENV = {
  ...
  ownerEmail: process.env.OWNER_EMAIL ?? "admin@new.com",
  ownerPassword: process.env.OWNER_PASSWORD ?? "new@2026",
  ownerOpenId: process.env.OWNER_OPEN_ID ?? "new-root-admin",
  ...
  emailFrom: process.env.EMAIL_FROM?.trim() || "New Imobiliária <nao-responda@localhost>",
  ...
  vapidSubject: process.env.VAPID_SUBJECT?.trim() || "mailto:contato@new.com",
};
