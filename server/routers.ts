...
const propertyLaunchMutationSchema = z.object({
  ...
  unidadesReservadas: z.number().int().min(0).max(10000).optional(),
  unidadesEmNegociacao: z.number().int().min(0).max(10000).optional(),
  unidadesVendidas: z.number().int().min(0).max(10000).optional(),
